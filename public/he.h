 ...
 */
he_return_code_t he_ssl_ctx_destroy(he_ssl_ctx_t *ctx);
...
/**
 * @brief Check if the auth callback has been set.
 * @param ctx A pointer to a valid SSL context
 * @return bool Returns true or false depending on whether it has been set
 */
 ...
 */
he_return_code_t he_plugin_destroy_chain(he_plugin_chain_t *chain);
